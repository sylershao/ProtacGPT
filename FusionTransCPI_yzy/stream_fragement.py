...
dataset_setting = config["dataset_name"]
# print(dataset_setting)

dataset = dataset_setting
train_d_encoder = pd.read_pickle("dataset/"+dataset+"/train_split_sub_smiles.pickle")
train_d_encoder = train_d_encoder['smiles_encoder']
test_d_encoder = pd.read_pickle("dataset/"+dataset+"/test_split_sub_smiles.pickle")
test_d_encoder = test_d_encoder['smiles_encoder']

val_d_encoder = pd.read_pickle("dataset/"+dataset+"/val_split_sub_smiles.pickle")
