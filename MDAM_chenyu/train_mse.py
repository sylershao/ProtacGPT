...
#from conv import CON_FUNCTIONS
from train_logging_mse import LOG
...
#common_args_parser.add_argument('--con', type=str, default='CON', choices=[k for k, v in CON_FUNCTIONS.items()])
common_args_parser.add_argument('--score', type=str, default='All', help='roc-auc or MSE or All')
common_args_parser.add_argument('--epochs', type=int, default=100, help='Number of training epochs')
...
def main():
    ...
    train_dataloader = DataLoader(train_dataset, batch_size=args.batch_size, drop_last=True, collate_fn=molgraph_collate_fn)
    ...
    for epoch in range(args.epochs):
        ...
        with torch.no_grad():
            net.eval()
            LOG[args.logging](
                 net, train_dataloader, validation_dataloader, test_dataloader, predictor, bcewithlogitsloss, criterion, mse, epoch, args)
